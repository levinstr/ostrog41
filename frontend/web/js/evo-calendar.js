            ...
            _.initials = {
                ...
                dates: {
                    ...
                    ru: {
                        ...
                        noEventForToday: "На сегодня нет мероприятий",
                        noEventForThisDay: "На сегодня нет мероприятий",
                        previousYearText: "Предыдущий год",
                        nextYearText: "Следующий год",
                        closeSidebarText: "Закрыть панель",
                        closeEventListText: "Закрыть события"
                    }
                }
            }
            _.initials.weekends = {
